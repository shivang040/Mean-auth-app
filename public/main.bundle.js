...
var appRoutes = [
    ...
    { path: 'dashboard', component: __WEBPACK_IMPORTED_MODULE_4__components_dashboard_dashboard_component__["a" /* DashboardComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_0__guards_auth_guard__["a" /* AuthGuard */]] },
    { path: 'profile', component: __WEBPACK_IMPORTED_MODULE_5__components_profile_profile_component__["a" /* ProfileComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_0__guards_auth_guard__["a" /* AuthGuard */]] },
];
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_9__angular_core__["NgModule"])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_5__components_profile_profile_component__["a" /* ProfileComponent */],
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_11_angular2_flash_messages__["FlashMessagesService"],
...
module.exports = "<div class=\"jumbotron text-center\">\n<h1> Mean Authentication App</h1>\n<p class=\"lead\">Welcome to our custom MEAN authentication application.</p>\n<div><a class=\"btn btn-primary\" [routerLink]=\"['/register']\">Register</a>\n  <a class=\"btn btn-primary\" [routerLink]=\"['/login']\">Login</a>\n</div>\n</div>\n\n<div class=\"row\">\n  <div class=\"col-md-4\">\n    <h3>Express Backend</h3>\n    <p>A rock solid node.js/express server using moongoose to organise models.</p>\n  </div>\n  <div class=\"col-md-4\">\n    <h3>Angular-CLI</h3>\n      <p>Angular-cli to generate components,services and more.</p>\n  </div>\n  <div class=\"col-md-4\">\n    <h3>JWT Tokens</h3>\n      <p>Full feeatured authentication using JSON web tokes.</p>\n  </div>\n</div>"
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
                _this.flashMessageService.show('You are registered', { cssClass: 'alert-success', timeout: 3000 });
                _this.router.navigate(['/login']);
            }
            else {
                _this.flashMessageService.show('You are not registered', { cssClass: 'alert-danger', timeout: 3000 });
...
var AuthGuard = /** @class */ (function () {
    ...
    AuthGuard = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0__services_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* Router */]])
    ], AuthGuard);
    return AuthGuard;
}());
